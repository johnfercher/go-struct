...
type ProductService interface {
	...
	Search(ctx context.Context, productType interface{}) ([]*productentities.Product, error)
	...
	Func(closure func(interface{}) bool) bool
}
`
